<!-- Parity corner-cases test document. Exercises ALL known bugs D1-D16, P1-P9 between Rust flowmark and Python flowmark v0.6.4. Expected output files are GENERATED by running Python flowmark, not hand-written. See: tests/test_parity_golden.rs -->
...
[^217]: Testing - : Is Ketamine Contraindicated?
    - REBEL EM - more words, <https://rebelem.com/test>

...
fn test_ellipses_multiple() {
    assert_eq!(ellipses("I think... well... maybe..."), "I think \u{2026} well \u{2026} maybe \u{2026}");
    ...
    assert_eq!(ellipses("I was thinking... maybe we should go."), "I was thinking \u{2026} maybe we should go.");
    assert_eq!(ellipses("The options are... well... complicated."), "The options are \u{2026} well \u{2026} complicated.");
}
...
fn test_ellipses_punctuation() {
    ...
    // Five or more dots: not converted
...
#[test]
fn test_ellipses_four_dots_with_word() {
    assert_eq!(ellipses("word....word"), "word \u{2026}.word");
    assert_eq!(ellipses("word....123"), "word \u{2026}.123");
}

#[test]
fn test_ellipses_quote_cases() {
    assert_eq!(ellipses("'...word"), "'\u{2026} word");
    assert_eq!(ellipses("'... word"), "'\u{2026} word");
    assert_eq!(ellipses("\"...word"), "\"\u{2026} word");
    assert_eq!(ellipses("\"... word"), "\"\u{2026} word");

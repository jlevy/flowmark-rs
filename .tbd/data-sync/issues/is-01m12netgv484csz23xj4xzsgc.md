...
updated_at: 2026-08-28T03:15:24.551Z
---
...
Python twin: fm-82mg. These are the Python-only shapes: Rust is stable on both today, so a Python fix will change bytes this port must then match.

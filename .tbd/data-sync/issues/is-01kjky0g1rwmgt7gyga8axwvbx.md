...
updated_at: 2026-03-02T18:01:05.520Z
---

## Notes

2026-03-02 validation: PyPI package exists at 0.2.5 and installs, but flowmark 0.2.5-dev.unknown+g784b6d0 (Rust port of flowmark-py 0.6.4; base v0.2.5) reports  (not stable release string). Keep this open until release metadata/version embedding is corrected and install checks pass for uvx, uv tool install, and pip install paths.
